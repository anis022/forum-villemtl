...
export function BackToTop({ label }: { label: string }) {
  return (
    <button
      ...
      className="inline-flex min-h-[40px] shrink-0 items-center whitespace-nowrap px-2.5 py-3 text-[12px] font-bold leading-[16px] text-[#6e6a72] transition-colors hover:text-[#a3162c] hover:underline"
    >
      {label}
    </button>
  );
